...
game:GetService("RunService").RenderStepped:Connect(function()
    ...
    if isEnabled then
        if closestPlayer then
            ...
            local args = {
                [1] = Vector3.new(closestPlayer.Head.Position.X, closestPlayer.Head.Position.Y, closestPlayer.Head.Position.Z),
                [2] = Vector3.yAxis
            }
            lplr.Character.Fuzil.EventsFolder.Fire:FireServer(unpack(args))
        end
    end
end)
